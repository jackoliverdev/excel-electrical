      ...
      >
        <div className="max-w-4xl space-y-6">
          <p className="text-brand-gold text-[11px] font-semibold uppercase tracking-[0.18em] md:text-xs">
            Friendly, local electricians you can rely on
          </p>
          ...
          <h1 className="text-4xl font-semibold leading-tight tracking-tight text-white md:text-5xl lg:text-6xl">
            ...
            <span className="block">safe &amp; powered</span>
          </h1>
